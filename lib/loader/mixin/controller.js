    ...
    opt = Object.assign({
      ...
      initializer: (obj, opt) => {  
        ...
        if (is.class(obj)) {
          ...
          // 遍历对象中的所有方法，修改方法值的时候作用域this，将方法修改为 async function(ctx,next)的方式，返回的是包含处理后所有方法的对象
          return wrapClass(obj);
        }
        if (is.object(obj)) {
          return wrapObject(obj, opt.path);
        }
        // 支持 generator 和 async 函数
